...
from app.routes import health, invitations, members, orgs
...
app.add_middleware(RateLimitMiddleware, redis=rate_limit_store, limit=25, period_s=10)
...
async def http_exception_handler(_request: Request, exc: HTTPException) -> JSONResponse:
    # Anti-enumeration: 401/403/404 collapse to identical body so role/membership cannot be probed.
