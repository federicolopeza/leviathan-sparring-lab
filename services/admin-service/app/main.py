...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://app.melispy.com", "https://admin.melispy.com"],
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)
app.add_middleware(RateLimitMiddleware, redis=rate_limit_store, limit=100, period_s=10)
...
async def http_exception_handler(_request: Request, exc: HTTPException) -> JSONResponse:
    if exc.status_code in {
        ...
        return JSONResponse(status_code=status.HTTP_401_UNAUTHORIZED, content={"detail": "Not Found"})
